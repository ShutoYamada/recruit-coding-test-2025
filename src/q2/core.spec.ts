...
describe('Q2 core', () => {
  ...
  it('aggregate basic', () => {
    ...
    const data = [
      ...
      '2025-01-03T15:00:00Z,u5,/c,200,100',
      '2025-01-04T03:00:00Z,u6,/c,200,51',
      '2025-01-04T03:00:00Z,u6,/d,200,51', // removed because top 3 of a date
      '2025-01-04T10:00:00Z,u7,/b,200,70',
      '2025-01-04T10:00:00Z,u8,/c,200,75',
      '1991-01-03T15:00:00Z,u9,/b,200,50',
      ...
      '1991-01-04T10:00:00Z,u420,/d,200,79',
      '1991-01-04T10:00:00Z,u420,/e,200,79',
      '1991-01-04T10:00:00Z,u420,/e,200,79',
      '1991-01-04T10:00:00Z,u420,/g,200,79', // removed because top 3 of a date
      '1991-01-04T10:00:00Z,u420,/b,200,79',
      '1980-02-10T10:00:00Z,u11,/c,200,75', // removed
      '1992-03-04T10:00:00Z,u11,/c,200,75',
      '1992-03-04T10:00:00Z,u11,/c,200,75',
      '1992-03-04T10:00:00Z,u11,/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/c,200,75',
      '1994-03-04T10:00:00Z,u11,/a/b,200,75',
      '1994-03-04T10:00:00Z,u11,/a/b,200,75',
      '1994-03-04T10:00:00Z,u11,/a/b,200,75',
      '1994-03-04T10:00:00Z,u11,/a/b,200,75',
      '1994-03-04T10:00:00Z,u11,/a/b,200,75',
    ...
    const correctAnswer = [
      ...
      { date: '1991-01-04', path: '/e', count: 2, avgLatency: 79 },
      { date: '1991-01-04', path: '/d', count: 1, avgLatency: 79 },
      { date: '1992-03-04', path: '/c', count: 3, avgLatency: 75 },
      { date: '1994-03-04', path: '/a/b', count: 7, avgLatency: 75 }, // test /a/b and /a/c
      { date: '1994-03-04', path: '/a/c', count: 7, avgLatency: 75 },
      { date: '2025-01-04', path: '/a', count: 3, avgLatency: 76 },
      { date: '2025-01-04', path: '/c', count: 3, avgLatency: 75 },
      { date: '2025-01-04', path: '/b', count: 2, avgLatency: 110 },
    ];
